                ...
                <tbody>
                    @foreach ($book as $item => $hasil)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route("book.destroy",$hasil) }}" method="post">
                                    <a href="{{route('book.edit',$hasil)}}"><button class="btn btn-warning" type="button"><i class="fa fa-code" aria-hidden="true"></i></button></a>
                                    @csrf
                                    @method("delete")
